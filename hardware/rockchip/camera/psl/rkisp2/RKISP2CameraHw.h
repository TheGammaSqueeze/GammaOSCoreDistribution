 ...
 */
#ifndef _CAMERA3_HAL_RKISP2CameraHw_H_
#define _CAMERA3_HAL_RKISP2CameraHw_H_
 ...
 * that writes result
 * in RKISP2 ControlUnit and Capture Unit update metadata result and return it
 */
...
class RKISP2CameraHw: public ICameraHw {
 public:
    explicit RKISP2CameraHw(int cameraId);
    virtual ~RKISP2CameraHw();
  ...
  // override of ICameraHw
    ...
    virtual status_t preProcessRequest(Camera3Request* request, int inFlightCount);
 ...
 private:
    RKISP2CameraHw(const RKISP2CameraHw& other);
    RKISP2CameraHw& operator=(const RKISP2CameraHw& other);
 ...
 private:  //members
    ...
    RKISP2ImguUnit *mImguUnit;
    RKISP2ControlUnit *mControlUnit;
...
#endif /* _CAMERA3_HAL_RKISP2CameraHw_H_ */
