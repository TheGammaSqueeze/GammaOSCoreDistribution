...
#ifndef INCLUDE_TVINPUT_BUFFER_MANAGER_H_
#define INCLUDE_TVINPUT_BUFFER_MANAGER_H_
...
//  TvInputBufferManager* manager = TvInputBufferManager::GetInstance();
//  if (!manager) {
//    /* Error handling */
//  }
//
...
class EXPORTED TvInputBufferManager {
 public:
  // Gets the singleton instance.  Returns nullptr if any error occurrs during
  // instance creation.
  static TvInputBufferManager* GetInstance();

  virtual ~TvInputBufferManager() {}
  ...
  // Frees |buffer| allocated with TvInputBufferManager::Allocate().
  //
  // Args:
...
#endif  // INCLUDE_TVINPUT_BUFFER_MANAGER_H_
