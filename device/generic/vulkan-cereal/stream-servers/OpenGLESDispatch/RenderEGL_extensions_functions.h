// Auto-generated with: android/scripts/gen-entries.py --mode=functions stream-servers/OpenGLESDispatch/render_egl_extensions.entries --output=stream-servers/OpenGLESDispatch/RenderEGL_extensions_functions.h
