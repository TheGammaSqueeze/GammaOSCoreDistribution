// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs stream-servers/OpenGLESDispatch/gles_common.entries --output=stream-servers/OpenGLESDispatch/gles_common_functions.h
