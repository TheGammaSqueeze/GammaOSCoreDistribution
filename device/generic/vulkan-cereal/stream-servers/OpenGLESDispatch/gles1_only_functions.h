// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs stream-servers/OpenGLESDispatch/gles1_only.entries --output=stream-servers/OpenGLESDispatch/gles1_only_functions.h
