// Auto-generated with: android/scripts/gen-entries.py --mode=static_translator_namespaced_header stream-servers/OpenGLESDispatch/gles1_extensions.entries --output=stream-servers/OpenGLESDispatch/gles1_extensions_static_translator_namespaced_header.h
