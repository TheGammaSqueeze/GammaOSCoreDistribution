// Auto-generated with: android/scripts/gen-entries.py --mode=static_translator_namespaced_header stream-servers/OpenGLESDispatch/render_egl.entries --output=stream-servers/OpenGLESDispatch/RenderEGL_static_translator_namespaced_header.h
