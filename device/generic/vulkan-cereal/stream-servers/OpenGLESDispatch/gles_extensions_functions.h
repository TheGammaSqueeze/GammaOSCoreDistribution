// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs stream-servers/OpenGLESDispatch/gles_extensions.entries --output=stream-servers/OpenGLESDispatch/gles_extensions_functions.h
