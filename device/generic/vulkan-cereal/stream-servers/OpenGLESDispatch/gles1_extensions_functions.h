// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs stream-servers/OpenGLESDispatch/gles1_extensions.entries --output=stream-servers/OpenGLESDispatch/gles1_extensions_functions.h
