// Auto-generated with: android/scripts/gen-entries.py --mode=functions stream-servers/OpenGLESDispatch/render_egl.entries --output=stream-servers/OpenGLESDispatch/RenderEGL_functions.h
