// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs stream-servers/OpenGLESDispatch/gles3_only.entries --output=stream-servers/OpenGLESDispatch/gles3_only_functions.h
