// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs stream-servers/OpenGLESDispatch/gles31_only.entries --output=stream-servers/OpenGLESDispatch/gles31_only_functions.h
