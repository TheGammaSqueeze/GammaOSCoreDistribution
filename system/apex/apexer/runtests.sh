...
unzip ${output_file} apex_manifest.pb -d ${output_dir}
...
# check the contents
sudo diff ${manifest_file} ${output_dir}/mnt/apex_manifest.pb
sudo diff ${manifest_file} ${output_dir}/apex_manifest.pb
