...
#ifndef C2_RK_COMPONENT_H_
#define C2_RK_COMPONENT_H_
...
private:
    ...
    public:
        ...
        void setComponent(const std::shared_ptr<C2RKComponent> &thiz);

    protected:
        void onMessageReceived(const sp<AMessage> &msg) override;

    private:
        std::weak_ptr<C2RKComponent> mThiz;
        bool mRunning;
    };
