...
public class MCUBlueOnStatusSeekBarPreference extends DialogPreference implements OnSeekBarChangeListener{
    ...
    public MCUBlueOnStatusSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
