...
public class USBOptionsActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(USBOptionsActivity.this, "Selected: " + items[which], Toast.LENGTH_LONG).show();
                dialog.dismiss();
    ...
    private String getCommand(int mode) {
        switch(mode) {
            case 0: return "svc usb setFunctions";
            case 1: return "svc usb setFunctions mtp";
            case 2: return "svc usb setFunctions ptp";
            case 3: return "svc usb setFunctions rndis";
            default: return "";
        }
    }
