...
/** Quick settings tile: RetroArch Menu Button Override **/
public class RetroArchMenuButtonOverrideTile extends QSTileImpl<BooleanState> {

    public static final String TILE_SPEC = "retroarchmenubuttonoverride";

    private static final String PROP_CONTROL = "persist.gammaos.retroarchoverride.backbutton";
    ...
    @Inject
    public RetroArchMenuButtonOverrideTile(
            QSHost host,
        ...
        // 1) Read persisted prop (default to ENABLED)
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        state.label = "RetroArch Menu Button Override";
    ...
    private void applyState(int state) {
        ...
        if (Log.isLoggable("RetroArchMenuButtonOverrideTile", Log.DEBUG)) {
            Log.d("RetroArchMenuButtonOverrideTile", PROP_CONTROL + "=" + state);
        }
    }
