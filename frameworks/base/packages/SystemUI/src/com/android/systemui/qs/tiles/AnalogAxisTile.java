...
/** Quick settings tile: Left Stick Invert **/
public class AnalogAxisTile extends QSTileImpl<BooleanState> {

    public static final String TILE_SPEC = "analogaxis";

    private static final String PROP_CONTROL    = "persist.gammaos.leftstickinvert";
    ...
    private void applyState(int state) {
        ...
        if (Log.isLoggable("AnalogAxisTile", Log.DEBUG)) {
            Log.d("AnalogAxisTile", "persist.gamma.leftstickinvert=" + mode);
        }
    }
