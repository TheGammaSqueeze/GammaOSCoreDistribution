...
/** Quick settings tile: DC Dimming Emulation **/
public class DCDimmingEmuTile extends QSTileImpl<BooleanState> {

    public static final String TILE_SPEC = "dcdimmingemulation";

    private static final String PROP_CONTROL    = "persist.gammaos.dcdimmingemulation";
    ...
    private void applyState(int state) {
        ...
        if (Log.isLoggable("DCDimmingEmuTile", Log.DEBUG)) {
            Log.d("DCDimmingEmuTile", PROP_CONTROL + "=" + state);
        }
    }
