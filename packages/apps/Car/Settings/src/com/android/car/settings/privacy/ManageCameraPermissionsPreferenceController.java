...
public class ManageCameraPermissionsPreferenceController extends
    ...
    public void updateState(Preference preference) {
        ...
        getPreference().setSummary(
                getContext().getString(R.string.camera_settings_loading_app_permission_stats));
        ...
        for (UserHandle user : users) {
            ...
            permController.countPermissionApps(
                    Collections.singletonList(Manifest.permission.CAMERA), /* flags= */ 0,
                    (numApps) -> {
                        mNumTotal += numApps;
    ...
    private void setAppCounts(int numTotal, int numHasAccess) {
        ...
        getPreference().setSummary(StringUtil.getIcuPluralsString(getContext(), arguments,
                R.string.camera_app_permission_summary_camera_on));
    }
