...
/**
 * All apps that have recently accessed camera.
 */
public class CameraRecentAccessViewAllFragment extends SettingsFragment {

    private boolean mShowSystem = false;
    private MenuItem mShowHideSystemMenu;
    private CameraRecentAccessViewAllPreferenceController mController;

    @Override
    protected int getPreferenceScreenResId() {
        return R.xml.camera_recent_requests_view_all_fragment;
    }
    ...
    public void onAttach(Context context) {
        ...
        mController = use(CameraRecentAccessViewAllPreferenceController.class,
                R.string.pk_camera_recent_requests);
    }
