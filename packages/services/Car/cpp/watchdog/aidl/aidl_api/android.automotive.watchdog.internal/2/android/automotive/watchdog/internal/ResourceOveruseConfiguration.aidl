...
parcelable ResourceOveruseConfiguration {
  ...
  List<android.automotive.watchdog.internal.PackageMetadata> packageMetadata;
  List<android.automotive.watchdog.internal.ResourceSpecificConfiguration> resourceSpecificConfigurations;
}
