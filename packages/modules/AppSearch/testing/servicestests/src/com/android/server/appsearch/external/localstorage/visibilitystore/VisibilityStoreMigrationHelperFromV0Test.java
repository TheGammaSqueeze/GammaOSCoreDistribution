...
import static com.android.server.appsearch.external.localstorage.visibilitystore.VisibilityStoreMigrationHelperFromV0.DEPRECATED_ACCESSIBLE_SCHEMA_PROPERTY;
import static com.android.server.appsearch.external.localstorage.visibilitystore.VisibilityStoreMigrationHelperFromV0.DEPRECATED_NOT_DISPLAYED_BY_SYSTEM_PROPERTY;
import static com.android.server.appsearch.external.localstorage.visibilitystore.VisibilityStoreMigrationHelperFromV0.DEPRECATED_PACKAGE_NAME_PROPERTY;
import static com.android.server.appsearch.external.localstorage.visibilitystore.VisibilityStoreMigrationHelperFromV0.DEPRECATED_PACKAGE_SCHEMA_TYPE;
import static com.android.server.appsearch.external.localstorage.visibilitystore.VisibilityStoreMigrationHelperFromV0.DEPRECATED_SHA_256_CERT_PROPERTY;
import static com.android.server.appsearch.external.localstorage.visibilitystore.VisibilityStoreMigrationHelperFromV0.DEPRECATED_VISIBILITY_SCHEMA_TYPE;
import static com.android.server.appsearch.external.localstorage.visibilitystore.VisibilityStoreMigrationHelperFromV0.DEPRECATED_VISIBLE_TO_PACKAGES_PROPERTY;
...
public class VisibilityStoreMigrationHelperFromV0Test {
    ...
    public void testVisibilityMigration_from0() throws Exception {
        ...
        GenericDocument deprecatedVisibilityToPackageFoo =
                new GenericDocument.Builder<>(
                        ...
                        .setPropertyString(
                                DEPRECATED_ACCESSIBLE_SCHEMA_PROPERTY, prefix + "Schema1")
        ...
        GenericDocument deprecatedVisibilityToPackageBar =
                new GenericDocument.Builder<>(
                                VisibilityDocument.NAMESPACE, "", DEPRECATED_PACKAGE_SCHEMA_TYPE)
                        .setPropertyString(
                                DEPRECATED_ACCESSIBLE_SCHEMA_PROPERTY, prefix + "Schema2")
        ...
        GenericDocument deprecatedVisibilityDocument =
                new GenericDocument.Builder<>(
                        ...
                        .setPropertyDocument(
                                ...
                                deprecatedVisibilityToPackageFoo,
                                deprecatedVisibilityToPackageBar)
                        .build();
    ...
    private AppSearchImpl buildAppSearchImplInV0() throws Exception {
        AppSearchSchema visibilityDocumentSchemaV0 =
                new AppSearchSchema.Builder(DEPRECATED_VISIBILITY_SCHEMA_TYPE)
                        .addProperty(
                        ...
                        .addProperty(
                                new AppSearchSchema.DocumentPropertyConfig.Builder(
                                        ...
                                        .build())
                        .build();
        AppSearchSchema visibilityToPackagesSchemaV0 =
