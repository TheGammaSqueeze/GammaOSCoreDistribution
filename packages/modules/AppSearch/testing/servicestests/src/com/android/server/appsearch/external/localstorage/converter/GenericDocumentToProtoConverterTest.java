...
public class GenericDocumentToProtoConverterTest {
    ...
    public void testConvertDocument_whenPropertyHasEmptyList() {
        ...
        propertyProtoMap.put("emptyLongKey", PropertyProto.newBuilder().setName("emptyLongKey"));
        propertyProtoMap.put(
                "emptyDoubleKey", PropertyProto.newBuilder().setName("emptyDoubleKey"));
        propertyProtoMap.put(
                "emptyBooleanKey", PropertyProto.newBuilder().setName("emptyBooleanKey"));
        propertyProtoMap.put(
                "emptyStringKey", PropertyProto.newBuilder().setName("emptyStringKey"));
        propertyProtoMap.put("emptyByteKey", PropertyProto.newBuilder().setName("emptyByteKey"));
        propertyProtoMap.put(
                "emptyDocumentKey", PropertyProto.newBuilder().setName("emptyDocumentKey"));
        ...
        PropertyConfigProto emptyStringListProperty =
                PropertyConfigProto.newBuilder()
                        ...
                        .build();
        PropertyConfigProto emptyByteListProperty =
                PropertyConfigProto.newBuilder()
                        .setCardinality(PropertyConfigProto.Cardinality.Code.REPEATED)
                        .setDataType(PropertyConfigProto.DataType.Code.BYTES)
                        .setPropertyName("emptyByteKey")
                        .build();
        PropertyConfigProto emptyDocumentListProperty =
                PropertyConfigProto.newBuilder()
                        .setCardinality(PropertyConfigProto.Cardinality.Code.REPEATED)
    ...
    public void testConvertDocument_whenNestedDocumentPropertyHasEmptyList() {
        ...
        DocumentProto outerDocumentProto =
                DocumentProto.newBuilder()
                        .setUri("id2")
        ...
        SchemaTypeConfigProto nestedSchemaTypeConfigProto =
                SchemaTypeConfigProto.newBuilder()
                        ...
                        .setSchemaType(PREFIX + SCHEMA_TYPE_1)
                        .build();
        PropertyConfigProto nestedDocumentProperty =
                PropertyConfigProto.newBuilder()
                        .setCardinality(PropertyConfigProto.Cardinality.Code.REPEATED)
                        .setDataType(PropertyConfigProto.DataType.Code.DOCUMENT)
                        ...
                        .setSchemaType(PREFIX + SCHEMA_TYPE_1)
                        .build();
        SchemaTypeConfigProto outerSchemaTypeConfigProto =
                SchemaTypeConfigProto.newBuilder()
